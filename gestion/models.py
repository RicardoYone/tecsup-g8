...
class Figura(models.Model):
    ...
    categoria = models.ForeignKey(
        to=Categoria, on_delete=models.PROTECT, related_name='figuras')
...
class Registro(models.Model):
    ...
    tipo = models.CharField(max_length=40, choices=(['NORMAL', 'NORMAL'], [
                            'ESPECIAL', 'ESPECIAL'], ['ESCUDO', 'ESCUDO']))
    # RELACIONES
    figura = models.ForeignKey(
        to=Figura, on_delete=models.PROTECT, related_name='figura_registros')
    usuario = models.ForeignKey(
        to=Usuario, on_delete=models.PROTECT, related_name='usuario_registros')
